...
if __name__ == '__main__':
  ...
  for data_path in data_paths:
    ...
    for i in (t := trange(fr.frame_count-LOOKAHEAD)):
      t.set_description("[+] Processing Frame", i+1)
      ...
      draw_path(frame_positions_local[i:i+LOOKAHEAD], img)
      cv2.imshow('path', img)
      cv2.waitKey(1)
